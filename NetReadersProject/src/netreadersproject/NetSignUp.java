 ...
 * @author ACER
 */
public class NetSignUp extends javax.swing.JDialog {

    /**
     * Creates new form NetSignUp
     */
    private int iWidth2;
    ...
    public NetSignUp(java.awt.Frame parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        setTitle("NetReaders");
        setMinimumSize(new java.awt.Dimension(539, 510));
        setResizable(false);
        setSize(new java.awt.Dimension(539, 474));
        ...
        jPanel3Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jButton1, newPassword, password});
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NetSignUp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NetSignUp dialog = new NetSignUp(new javax.swing.JFrame(), true);
